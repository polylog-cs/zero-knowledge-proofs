...
export class Lock extends Node {
    ...
    public constructor(props?: LockProps) {
        ...
        this.add(
            <>
                <Rect ref={this.background} width={w} height={() => h() * this.openScale()} fill={Solarized.base02} stroke={Solarized.base01}
                      scale={0} lineWidth={lw} zIndex={-1} radius={r}
                      position={this.object.position}
                />
                <Rect ref={this.top} width={w} height={() => h() / 2} fill={Solarized.base00} zIndex={1}
                      top={this.background().top}
                      opacity={0} radius={() => [r(), r(), 0, 0]}
                      shaders={{
                ...
                />
                <Rect ref={this.bottom} width={w} height={() => h() / 2} fill={Solarized.base00} zIndex={1}
                      bottom={this.background().bottom} opacity={0} radius={() => [0, 0, r(), r()]}
                      shaders={{
                          fragment: gradientShader,
                          uniforms: {
                              mixColor: [0, 0, 0, 0],
